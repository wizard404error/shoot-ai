...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=12,
        help="Sample every Nth detection frame (so every N*skip video frames)",
    )
    parser.add_argument(
        "--max-frames", type=int, default=20, help="Max frames to show for annotation"
    )
